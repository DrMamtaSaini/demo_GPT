    ...
    try:
        response = requests.post(
            ...
            json={
                ...
                "application_context": {
                    "return_url": "https://teachersgpt.streamlit.app/?page=success",
                    "cancel_url": "https://teachersgpt.streamlit.app/?page=cancel",
                },
            },
        )
        response.raise_for_status()
...
def success_page():
    ...
    if not order_id:
        st.error("Missing order ID in the redirect URL.")
        return
...
def cancel_page():
    ...
    st.warning("The payment process was canceled. You can try again.")
